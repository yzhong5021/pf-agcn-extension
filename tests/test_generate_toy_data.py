...
Minimal checks for toy data utilities.
"""
...
def test_random_sequence_fixed_length():
    np.random.seed(0)
...
def test_generate_toy_data_shapes():
    df, vocab, labels = generate_toy_data(n_samples=4, n_go_terms=3, min_len=4, max_len=6, seed=7)
